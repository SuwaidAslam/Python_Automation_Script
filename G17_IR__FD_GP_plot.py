# %% [markdown]
# # GOES-17 IR channel full disk plot in geostationary projection
# This jupyter notebook shows how to make a full disk plot of a IR channel of GOES-17 in geostationary projection.
...
C08_files = GOES.locate_files(PATH_OUT,
                          'OR_ABI-L2-CMIPF-M*C13_G17*.nc', START_DATE, END_DATE)
file = C08_files[0]
...
filename = f"G17_IR__FD_GP_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
