# %% [markdown]
# # GOES-16 VIS channel subregion plot
# This jupyter notebook shows how to make a sub-region plot of a VIS channel of GOES-16.
...
# %% [markdown]
# Gets image with the coordinates of centers of their pixels.
...
filename = f"G16_VIS_SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
