# %% [markdown]
# # Convert L1b data to L2 data of a IR channel and make its plot
# This jupyter notebook shows how to convert L1b data to L2 data of a IR channel of GOES-16 and make a sub-region plot.
...
files = GOES.locate_files(PATH_OUT,
                          'OR_ABI-L1b-RadF-M*C13_G16*.nc', START_DATE, END_DATE)
file = files[0]
# %% [markdown]
...
# %%
CMI, LonCor, LatCor = ds.image('Rad', lonlat='corner', domain=domain, up_level=True)
...
filename = f"G16_L1b_to_L2_IR__SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
