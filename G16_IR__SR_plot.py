# %% [markdown]
# # GOES-16 IR channel subregion plot
# This jupyter notebook shows how to make a sub-region plot of a IR channel of GOES-16.
...
filename = f"G16_IR__SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
