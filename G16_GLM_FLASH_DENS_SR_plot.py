# %% [markdown]
# # Plots the flash density of GLM
# This jupyter notebook shows how to make a sub-region plot of the flash density of GLM.
...
filename = f"G16_GLM_FLASH_DENS_SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
