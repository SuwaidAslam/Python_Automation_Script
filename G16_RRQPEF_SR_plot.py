...
files= GOES.locate_files(PATH_OUT, 'OR_ABI-L2-RRQPEF*.nc',
                        START_DATE, END_DATE)
file = files[0]
...
timestamp = RRQPE.time_bounds.data[0].strftime('%Y/%m/%d %H:%M UTC')

# Save the plot as an image file with the timestamp as the name
filename = f"G16_RRQPEF_SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
