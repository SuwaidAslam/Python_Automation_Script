# %% [markdown]
# # GOES-17 IR channel subregion plot
# This jupyter notebook shows how to make a sub-region plot of a IR channel of GOES-17.
...
cb = plt.colorbar(img, ticks=ticks, orientation='horizontal', extend='both',
                  cax=fig.add_axes([0.12, 0.21, 0.76, 0.02]))
...
filename = f"G17_IR__SR_plot_{timestamp}.png"  # Example filename: plot_20230714123456.png
